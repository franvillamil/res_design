...
\begin{itemize}
  ...
  \item<2-> What if we want to \textit{predict the future}?
\end{itemize}
...
\begin{itemize}
  \item Importance of meta-scientific knowledge
  \begin{itemize}
...
\begin{itemize}
  ...
  \item<2->[2.] Construct validity of the \BGyellow{outcome}: similar, making sure the empirical measure mirrors the theoretical construct
\end{itemize}
