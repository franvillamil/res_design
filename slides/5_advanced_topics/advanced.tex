...
\begin{itemize}
  ...
  \end{itemize}
  \item What are we really learning? \uncover<2->{How much \textit{knowledge} we gain?}
  \item[]
...
% ----------------------------------------------------
\imageframe{../img/normal-looking-funnel-plot}
% ----------------------------------------------------

% ----------------------------------------------------
\imageframe{../img/skewed-funnel-plot}
% ----------------------------------------------------
...
\begin{itemize}
  ...
  \item
  % \item {\footnotesize See \href{https://dynamicecology.wordpress.com/2021/05/17/what-the-heck-is-up-with-the-many-ecological-meta-analyses-that-have-inverted-funnel-plots/}{this for an example discussion on ecology}}
\end{itemize}
