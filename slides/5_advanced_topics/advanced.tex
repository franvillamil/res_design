...
% Title --------------------------------------------
\title[Lecture 5: Advanced topics]{\Large Generalization \& overview}
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Design example}
\centering

Let's say we're interesting in exploring the problem of\\\textbf{AI automation and the labor market},\\where do we start?

\vspace{25pt}

\begin{flushleft}
{\small Remember:}\\\vspace{10pt}
% ----------------------------------------------------
\begin{minipage}{.4\textwidth}
  \begin{enumerate}\footnotesize
  \item Topic
  \item RQ
  \item Theory and mechanisms
\end{enumerate}
\end{minipage}
% ----------------------------------------------------
\begin{minipage}{.5\textwidth}
  \begin{enumerate}\footnotesize\setcounter{enumi}{3}
  \item Concepts, measurement
  \item Strategy
  \item {\color{blue}{Results, interpretation \& relevance}}
\end{enumerate}
\end{minipage}
% ----------------------------------------------------
\end{flushleft}
...
\begin{itemize}
  ...
  \end{itemize}
  \item What are we really learning? How much \textit{knowledge} we gain?
\end{itemize}
...
\begin{itemize}
  \item[1.] Connection theory-empirics
  \begin{itemize}
    \item We start with big questions and then narrow them down
    \item Usually because we need to so in order to answer \textit{something}
    \item But it is important to look back at the big question
    \item Think that in \textbf{every decision} on RQs, concepts, measurements, strategy... you lose some detail
  \end{itemize}
  \item<2->[2.] Importance of meta-scientific knowledge
  \begin{itemize}
    \item[] Quantitative approaches for looking at the big picture
...
\begin{itemize}
  \item Effect of natural resources (oil, diamonds, etc) on conflict
...
\begin{itemize}
  \item Idea: Commodity \textbf{prices} are often \textbf{exogenous} to internal conflict
\end{itemize}
...
% ----------------------------------------------------
\begin{frame}
\frametitle{How are meta-analyses done}
\centering
...
\begin{itemize}
  ...
  \item<3->[2.] Construct validity of the \BGyellow{outcome}: similar, making sure the empirical measure mirrors the theoretical construct: thing e.g. about measuring polarization
\end{itemize}
...
\uncover<1->{\includegraphics[width = 0.8\textwidth]{../img/matching_dag_distance}}
...
\uncover<1->{\includegraphics[width = .85\textwidth]{../img/matching_dag_ps}}
