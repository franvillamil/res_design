...
\begin{itemize}
  \item \BGyellow{\textbf{Groups?}} Send me an email \textbf{\colorbox{yellow}{before} Oct 14th}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item two of them used for controlling (closing back-doors), and the other three to exploit `pre-made` causal models
...
\begin{itemize}
  \item Treatments usually occur at a particular moment in time, e.g.:
    ...
    \end{itemize}
  \item<2-> A naive idea would be to compare how it was \textit{before} the treatment with how it is \textit{after} the treatment, right?
    \begin{itemize}
      \item e.g. in municipalities that removed Francoist streets, how much did Vox grow between 2016 and 2019?
    \end{itemize}
  \item<3-> or we could just compare treated vs control \textit{after} treatment
    \begin{itemize}
      \item e.g. did Vox get more votes in 2019 in municipalities that removed F streets?
    \end{itemize}
  \item<4-> \textbf{DiD idea}: use a control group that works as a \BGyellow{counterfactual} for how much would $Y$ have changed without treatment
  \end{itemize}
...
% ----------------------------------------------------
\begin{frame}
\frametitle{DiD and staggered treatments}
\centering

\begin{itemize}
  \item Normal DiD works on a before/after setting, where treatment affects all units at the same time
  \item What if treatment is \textbf{staggered}?
\end{itemize}
...
\begin{itemize}
  \item Different strategies to deal with this
  \item Naive: Two-Way Fixed Effects (TWFE)
  \begin{itemize}
    \item Problem when having heterogenous effects over time
  \end{itemize}
  \item More recently: DiD estimates under treatment heterogeneity
  \begin{itemize}
    \item Goodman-Bacon 2021 {\footnotesize (``Difference-in-Differences with Variation in Treatment Timing'')}
    \item Callaway and Sant'Anna 2021 {\footnotesize (``Difference-in-Differences with Multiple Time Periods'')}
    \item Roth et al. 2023 {\footnotesize (``What’s Trending in Difference-in-Differences?'')}
  \end{itemize}
\end{itemize}
...
% ----------------------------------------------------
\imageframe{../img/staggered2}
% ----------------------------------------------------
  
% ----------------------------------------------------
\imageframe{../img/staggered3}
% ----------------------------------------------------

% ----------------------------------------------------
\imageframe{../img/staggered4}
% ----------------------------------------------------

% % ----------------------------------------------------
% \imageframe{../img/exhumacion_argentina}
% % ----------------------------------------------------

% % ----------------------------------------------------
% \imageframe{../img/map_graves}
% % ----------------------------------------------------

% % ----------------------------------------------------
% \imageframe{../img/map_graves_exhumation}
% % ----------------------------------------------------
      
% % ----------------------------------------------------
% \imageframe{../img/exhumaciones_navarra}
% % ----------------------------------------------------
...
\begin{itemize}
  ...
  \end{itemize}
  \item<2-> The source of the exogenous variation:
  \begin{itemize}
...
\begin{itemize}
  ...
  \end{itemize}
  \item<2-> \BGyellow{Precise sorting}: maybe something is \textit{actually} affecting sorting around the cutoff (next example)
  \item<3-> Causal effect \BGyellow{independent of treatment}: being above/below cutoff affects $Y$ independent of the treatment we're interesting in
\end{itemize}
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Overview of the 3 design templates}
\centering
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Example: Instrumental variables}
\centering

\includegraphics[width = \textwidth]{../img/india_riots1}
...
\includegraphics[width = \textwidth]{../img/india_riots2}
  
\begin{itemize}
  \item<2-> What's the \textbf{problem} here?
\end{itemize}
...
\begin{itemize}
  \item<2-> What could be a source of \textbf{exogenous variation}? (i.e. quasi-experiment)
\end{itemize}
...
\includegraphics[width = \textwidth]{../img/india_riots4}
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Example: Regression discontinuity}
\centering

\includegraphics[width = \textwidth]{../img/boix_jewish1}

\end{frame}
% ----------------------------------------------------

% ----------------------------------------------------
\imageframe{../img/boix_jewish2}
% ----------------------------------------------------
% ----------------------------------------------------
\imageframe{../img/boix_jewish3}
% ----------------------------------------------------
% ----------------------------------------------------
\imageframe{../img/boix_jewish4}
% ----------------------------------------------------
% ----------------------------------------------------
\imageframe{../img/boix_jewish5}
% ----------------------------------------------------
...
% ----------------------------------------------------
\begin{frame}
\frametitle{(Extra) Example on theory, evidence and putting it all together}
\centering

\includegraphics[width = \textwidth]{../img/race_democratic_peace}
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Remember, usual causal inference strategies}
\centering

\begin{enumerate}
  \item {\color{red}{Fixed effects}}
  \item {\color{blue}{Difference-in-differences}}
  \item {\color{blue}{Regression discontinuity design}}
  \item {\color{blue}{Instrumental variables}}
  \item {\color{red}{Matching}}
\end{enumerate}
...
\begin{itemize}
  ...
  \end{itemize}
  \item<2-> Matching builds on this, and it is essentially about keeping in the same only comparable observations, or \textit{matched pairs}
  \item<3-> \href{https://www.nickchk.com/anim/Animation\%20of\%20Matching.gif}{Example of $Y \leftarrow Treatment$ matching on $X$}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Example from Ukraine survey paper {\small (combining matching with other)}
  \end{itemize}
